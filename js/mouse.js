function moveMouse(e) {
  // rclientX - движение мышки по оси х. innerHeight - высота окна. так как наш курсор нарисованный уходит за пределы сайте немного, примерно на 5 пикселей
...
if (window.innerWidth >= 768) {
  ...
  // наведение на элемент. mouseleave - мышь убираем
